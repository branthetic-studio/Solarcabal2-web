    ...
    <div className="px-4 py-10 md:px-9 md:py-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
          {/* Premium Quality */}
          <div className="bg-[#fafafa] rounded-2xl p-6 md:p-8 flex flex-col items-center md:items-start text-center md:text-left">
            <Image
              src={profimg1}
              alt="Premium Quality"
            ...
            <p className="text-[#525252] text-xs md:text-sm leading-relaxed">
