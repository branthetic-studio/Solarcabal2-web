        ...
        {!loading &&
          ...
          items.slice(0, 4).map((item, index) => (
            <Link
              ...
              className="product relative"
            >
              {/* Badge — Best Seller (first item) */}
              {index === 0 && (
                <div className="absolute top-2 left-2 flex w-full pr-6 justify-between items-center">
                  <span className="bg-[#ff0000] text-white text-xs lg:text-sm px-2 lg:px-3 py-1 lg:py-2 rounded-xl">
                    Best Seller
                  </span>
                  <div className="bg-[#ffffff] shadow-lg shadow-black/30 rounded-4xl p-1 cursor-pointer">
                    <Image
              ...
              {/* Badge — New (second item) */}
              {index === 1 && (
                <div className="absolute top-2 left-2 flex w-full pr-6 justify-between items-center">
                  <span className="bg-[#000000] text-white text-xs lg:text-sm px-2 lg:px-3 py-1 lg:py-2 rounded-xl">
                    New
                  </span>
                  <div className="bg-[#ffffff] shadow-lg shadow-black/30 rounded-4xl p-1 cursor-pointer">
                    <Image
              ...
              <div className="product-detail">
                <h6>{formatPrice(item.priceWithTax)}</h6>
                <Rate />
                <h5 className="text-xs lg:text-sm line-clamp-2">{item.productName}</h5>
              </div>
            </Link>
          ))}
