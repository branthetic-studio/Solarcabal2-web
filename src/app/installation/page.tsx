...
const steps = [
  {
    ...
    description: 'Tell us about your space, power needs, and budget. Our solar advisors will help you pick the right system, no pressure, just guidance.',
  },
  {
    title: 'Site Assessment & Design',
    description: 'Our certified engineers will assess your roof, wiring, and energy usage (physically or virtually) to design the ideal solar setup for your home or business.',
  },
  {
    title: 'Professional Installation',
    description: 'On your chosen date, our trained technicians will install the full system panels, inverter, batteries, and safety components quickly and cleanly, without disrupting your space.',
  },
  {
    title: 'System Activation',
    description: 'We will run safety tests, guide you through how everything works, and activate your system. You start saving on power from Day One.',
  },
];
    ...
    <div>
      ...
      <div className='installation-banner'>
        ...
        <div className='installation-banner-container'>
          <div className='installation-banner-content'>
            ...
            <p>Experience seamless solar energy installation with SolarCabal. Our expert team ensures a smooth transition to sustainable power, tailored to your needs.</p>
      ...
      <section className="installation-section">
        ...
        <p className="installation-subtitle">
          Getting solar with SolarCabal is simple, safe, and fully handled by experts.
        </p>
