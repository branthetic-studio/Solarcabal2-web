...
//     <div className="lg:hidden min-h-screen bg-white flex flex-col px-6 pt-6 pb-10 -mt-16 lg:-mt-24">
//       {/* Top bar */}
...
export default function RegisterLandingPage() {
  ...
  return (
    // Only show on mobile — desktop uses the modal
    <div className="lg:hidden min-h-screen bg-white flex flex-col justify-between px-6 pt-6 pb-8 -mt-16 lg:-mt-24">
      ...
      {/* SECTION 2 — Actions (button, socials, login) */}
