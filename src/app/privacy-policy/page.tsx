...
const sections: Section[] = [
  {
    ...
    content: [
      ...
      "Ecommerce & Transaction Information: Billing/shipping addresses, order history.",
      "Financial Information: Bank account details, card information (processed securely via partners).",
      "Identity Verification (KYC): Government-issued IDs, proof of address.",
      "Referral & Rewards Data: Codes, referral activity, earned incentives.",
      "Demographics & Profile Data: Age, gender, location, preferences.",
      "Usage & Device Data: IP address, device type, app interactions, cookies.",
    ],
  },
  {
    id: 2,
    ...
    content: [
      ...
      "Process purchases, payments, and product deliveries.",
      "Verify identity and prevent fraud.",
      "Administer referral and BNPL programs.",
      "Personalize offers, promotions, and content.",
  ...
  { id: 4, title: "Ecommerce Purchases", content: "We collect necessary data to process your orders and communicate status updates, including billing and delivery addresses and purchase history." },
  ...
  { id: 7, title: "Product Delivery", content: "Shipping addresses and contact details are used to ensure timely and accurate delivery of purchased products." },
  ...
  { id: 12, title: "Cookies and Similar Technologies", content: "We use cookies to enhance functionality, track app usage, and deliver personalized content. Users may manage cookie preferences in their browser settings." },
  { id: 13, title: "Governing Principles of Data Processing", content: "We process personal data lawfully, fairly, and transparently. Data collection is limited to what is necessary, maintained accurately, and stored securely." },
  {
    ...
    content: [
      ...
      "Service providers (payment processors, delivery partners, analytics).",
      "Promotional partners (with your consent).",
  ...
  { id: 15, title: "Personal Data Retention Period", content: "We retain data only as long as necessary to provide services, comply with laws, resolve disputes, and enforce agreements. Data is securely deleted or anonymized when no longer needed." },
  {
    ...
    content: [
      ...
      "Contact support@solarcabal.com to exercise your rights.",
    ],
  },
  ...
  { id: 23, title: "Remedies", content: "If you believe your data rights have been violated, you may contact us at support@solarcabal.com or report to relevant data protection authorities." },
  {
    ...
    content: [
      "Email: support@solarcabal.com",
      "Phone: 07074907903 or 07074728575",
      "Address: 1A Isolo Road, Mushin, Lagos",
    ],
  },
  { id: 25, title: "Notification of Changes", content: "We may update this Privacy Policy at any time. Significant changes will be communicated via the app or email. Continued use indicates acceptance of the updated policy. We recommend reviewing this policy regularly." },
];
  ...
  return (
    <div style={{ borderBottom: "1px solid #eee" }}>
      ...
      >
        ...
        <span style={{ flex: 1, fontSize: 15, fontWeight: 600, color: "#1a1a1a" }}>
          {s.title}
        </span>
        <span
          style={{
...
export default function PrivacyPolicy() {
  return (
    <div>
      ...
      >
        <h1 style={{ fontSize: 32, fontWeight: 700 }}>Privacy Policy</h1>
        <p style={{ color: "#777" }}>SolarCabal Technology Limited</p>
        <span
          style={{
      ...
      <div className="py-16 px-16" style={{ marginTop: 48, background: "#fafafa", border: "1px solid #e5e5e5", borderRadius: 10 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 12 }}>
          {contacts.map(({ label, value, href }) => (
            <div key={label} style={{ background: "#fff", border: "1px solid #eee", borderRadius: 8, padding: 14 }}>
              ...
              <p style={{ fontSize: 14 }}>
                {href ? (
                  <a href={href} style={{ color: "#ff0000" }}>
                    {value}
                  </a>
                ) : (
                  value
