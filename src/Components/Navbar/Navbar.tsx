...
//   useEffect(() => {
//     if (customer && authOpen) setAuthOpen(false);
//   }, [customer, authOpen]);
...
//   // On mobile, clicking the profile icon navigates to /register
//   // On desktop, it opens the AuthModal as before
...
//   return (
//     <>
//       <nav className="fixed top-0 left-0 right-0 z-50 w-full flex items-center justify-center lg:py-6 bg-[#f5f5f5] ">
//         <div className="w-full flex items-center justify-between bg-white px-4 lg:px-5 lg:mx-12 py-3">
...
//               width={50}
//               height={50}
//               className="w-7 h-7 lg:w-[50px] lg:h-[50px]"
//             />
//           </Link>
...
//             {/* Profile icon → /register or account */}
//             {loading ? (
//               <div className="w-9 h-9 animate-pulse rounded-full bg-gray-100" />
//             ) : customer ? (
//               <button
...
//               >
//                 <Image src="/profile.png" alt="Account" width={22} height={22} />
//               </button>
//             ) : (
//               <button
...
//               >
//                 <Image src="/profile.png" alt="Login" width={22} height={22} />
//               </button>
//             )}
...
//               <Image src="/shop-cart.png" alt="Cart" width={20} height={20} />
//               {cartCount > 0 && (
//                 <span className="absolute -top-1 -right-1 bg-red-600 text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-bold">
//                   {cartCount > 99 ? "99+" : cartCount}
//                 </span>
//               )}
//             </Link>
...
//       {/* Mobile Drawer */}
//       <div
//         className={`fixed top-0 right-0 h-full w-80 bg-white z-50 transform transition-transform lg:hidden ${
...
//                 pathname === href ? "text-[#FF0000]" : "text-gray-700"
//               }`}
//               onClick={() => setOpen(false)}
//             >
//               {label}
...
//                 }}
//                 className="w-full rounded-full bg-red-600 text-white py-3 text-sm font-semibold"
//               >
//                 Login / Register
//               </button>
//             )}
        ...
        <div className="w-full flex items-center justify-between bg-white px-4 lg:px-5 lg:mx-12 py-3">
          ...
          <ul className="hidden lg:flex items-center gap-8 flex-1 justify-center">
            {[
              { href: "/", label: "Home" },
              { href: "/products", label: "Products" },
              { href: "/installation", label: "Solar Packages" },
              { href: "/enquiries", label: "Enquiries" },
              // { href: "/referral", label: "Referral Program" },
              { href: "/faq", label: "FAQ" },
            ].map(({ href, label }) => (
      ...
      >
        ...
        <div className="p-6 flex flex-col gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 text-sm font-medium py-1 text-gray-700 hover:text-[#FF0000] transition-colors text-left"
          >
